...
from mola.data.humanml.scripts.motion_process import (qrot,
                                                     recover_root_rot_pos)


class MoLALosses(Metric):
    """
    MoLA Loss
    """
    ...
    def __init__(self, vae, mode, cfg):
        ...
        if self.stage in ['vae', "vae_gan", 'vae_san']:
            # reconstruction loss
        ...
        if self.stage not in ['vae', "vae_gan", 'vae_san', 'diffusion']:
