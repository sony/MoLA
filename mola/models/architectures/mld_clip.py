...
from transformers import AutoModel, AutoTokenizer, CLIPTextModel, CLIPTokenizer, AutoProcessor, AutoModelForZeroShotImageClassification
...
class MldTextEncoder(nn.Module):
    ...
    def __init__(
        ...
        self.text_model = AutoModelForZeroShotImageClassification.from_pretrained("openai/clip-vit-large-patch14")
