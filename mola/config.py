...
def parse_args(phase="train"):
    ...
    if phase == "demo":
        ...
        group.add_argument(
            ...
            type=str,
            required=False,
            help="input control signal for motion editing (e.g., start-end, lower-body, path)",
        )
        group.add_argument(
            "--task",
            type=str,
    ...
    if phase == "demo":
        ...
        cfg.DEMO.CONTROL = params.control
        ...
        cfg.DEMO.EDITING = params.editing
